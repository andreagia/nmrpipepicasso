...
picref = Channel.fromPath("./input/ref.csv", checkIfExists:false)
...
process runPicasso {
    ...
    script:
    """
    if  test -f "./input/ref.csv"; then
         echo "TROVATO"
        python /picasso/estimateShifts.py --free ./input/ref.csv  --with_ligand  out.csv  --N_divisor 5 --alg RA
    else
